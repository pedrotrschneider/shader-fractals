...
Este é um shader voltado para a renderização matemática do Brócolis de Menger, um fractal baseado na
...
This shader targets to achieve a mathematical render of Menger's Brocolli, a fractal based on the more
