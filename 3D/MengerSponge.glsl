...
Este é um shader voltado para a renderização matemática da Esponja de Menger, uma generalização para
maiores dimensões do Carpete de Sierpinski.
...
This shader targets to achieve a mathematical render of Menger's Sponge, a generalization to higher
