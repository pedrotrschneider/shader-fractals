...
Este é um shader voltado para a renderização matemática do Bulbo de Mandelbrot, um fractal baseado na
...
This shader targets to achieve a mathematical render of Mandelbrot's Bulb, a fractal based on the same
